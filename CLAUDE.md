...
| **Changing a parser / eval core** | Write pure core (DOM-free). Add name to `load-cores.mjs` `need` array. Pin with seeded tests. Run `node --test tests/test.mjs` green. Then wire DOM. |
