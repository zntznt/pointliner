...
wins over a plugin pack; otherwise last definition wins — keep names unique.)
...
The count is 1–99; results are joined by spaces. (For draw-*without*-repeat, use a deck instead.)
