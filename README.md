...
<!-- IMAGE: app at rest, full viewport. Show the toolbar, outline with 5–6 points, and at
     least one {2d6} pill and one {= sum(cost)} pill rendered live. ~900px wide. -->
...
<!-- IMAGE: a point with several pills side by side: dice, math, grammar, estimate — all rendered
     as live widgets. Show the diversity of the {…} language. ~900px wide. -->
...
<!-- IMAGE: a base / table with rows, columns, and a {= sum(cost)} formula visible. Show the
     interactive table widget with a recipe row. ~900px wide. -->
