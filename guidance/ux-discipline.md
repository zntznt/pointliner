...
| Links (`[[ ]]`) | ✅ | ✅ (`[[` picker live — UXP-4; Copy-link stays the power path) | ◐ (picker is listbox/option + activedescendant; **the rendered link pill itself is keyboard-dead in display mode — UXP-53**) | ✅ (rename repaints on-screen links immediately) |
| Footnotes / hashtags / emoji | ✅ | ✅ (`#` tag picker — UXP-10) | ◐ (hashtag chips fully operable — UXP-39; emoji is non-interactive text; **the fn-ref trigger is hover-only — no keyboard/touch/AT — UXP-55**) | ✅ |
