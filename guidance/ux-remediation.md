...
### QX-6 ☐ Link and tag presence filters: `has:link` / `has:tag` (pure) + `has:backlink` / `is:broken` (threaded index) 🟡 (planned)
...
### UXP-145 ☐ Oracle valence tint is dialog-only; the recommended demo imports flat (P1/P5, solo) 🟡  [Batch 1]
...
### UXP-146 ☐ Whole-folder search silently truncates at 50 with a count that reads complete (P4) 🟡  [Batch 1]
...
### UXP-147 ☐ Default-tier users can't recover an unnoticed destructive edit after reload/crash (P4/service) 🟡  [Batch 2]
...
### UXP-148 ☐ Examples doc is a destroy-on-first-contact one-shot; the promised re-entry was never built (P2/service) 🟢  [Batch 2]
...
### UXP-149 ☐ est pill debut announce drops its result; thinner than a re-roll (P4) 🟢  [Batch 3]
...
### UXP-150 ☐ Spent `once` deck toast withholds the reset route (P2, copy) 🟢  [Batch 3]
...
### UXP-151 ☐ Priorities above C render as uncolored chips (P5/graphic, importer) 🟢  [Batch 3]
...
### UXP-152 ☐ Non-FSA save status line says "saves to file" but downloads a copy (P1/P4, copy) 🟢  [Batch 3]
...
### UXP-153 ☐ Toggle buttons flip their accessible NAME while also carrying aria-pressed (P3) 🟢  [Batch 3]
...
### UXP-159 ⊘ Subtree rollups / progress cookies stop at direct children (DECISION-PENDING, needs owner sign-off) 🟢
