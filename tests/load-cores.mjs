...
export function loadCores() {
  ...
  const need = [
    ...
    'parseSearchQuery','termMatchesNode','queryMatchesNode','searchHighlightNeedles','queryRows','queryParts','queryTableRows','parseQBaseCols','mtCellHtml','mtSetColRole','boardLanes','calBaseItems',
