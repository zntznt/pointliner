...
export function loadCores() {
  ...
  const need = [
    ...
    'textBlockPrefix','normStateKey','boardBlockReason','statusColWarning','baseStructMessage','colWidthLabel','mtColValueCount','mtRowValueCount','blockCmdsPool','slashActiveIdx',   // #1114: state matching, the Board refusal (#1401: and its now-shared unknown-values half), the slash pool
